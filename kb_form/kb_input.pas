...
uses
  ...
  Vcl.WinXCtrls, main, cxMemo, gl_browse;
        ...
        if kb_grtv.DataController.RowCount <> 0 then begin
          ...
          // fill BKPF table.
           try
            ...
            kbi_bkpf_q.Append;
            //kbi_bkpf_q.ParamByName('iddoc').AsString := nodoc_TE.Text;
          ...
          //fill BSEG table part 2
            ...
            kbi_bseg_q.CommitUpdates;
                ...
                mainmenu.StatusBar1.SimpleText:= 'testing';
                ShowMessage('testing');
          end;
      end;
        //ShowMessage('ada');
